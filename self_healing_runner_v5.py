...
def write_module_summary(phase: int, module: str, rows: List[Tuple[str, str]], summary_dir: str) -> str:
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ap = argparse.ArgumentParser(description="Patch 2: Normalize + filter manifest entries with diagnostics")
    ...
    ap.add_argument("--summary-dir", default=os.path.join(ROOT, "outputs", "summaries"), help="Where to write TSV summaries")
