...
class GraphicsStateMixin:
    ...
    def font_face(self):
        ...
        return FontFace(
            ...
            color=(self.text_color if self.text_color != self.DEFAULT_TEXT_COLOR else None),
            fill_color=(self.fill_color if self.fill_color != self.DEFAULT_FILL_COLOR else None),
        )
