...
def normalize_youtube_trends(api_csv, autocomplete_csv, output_csv):
    ...
    print("â�"… Autocomplete data cleaned")
    ...
    print(f"â�"… Normalized trends saved to {output_csv}")
