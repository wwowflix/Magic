...
def _makeMacName(name, nameID, language, font=None):
    ...
    if font is not None:
        ...
        # 0 = Unicode; 4 = â€œUnicode 2.0 or later semantics (non-BMP characters allowed)â€
        # â€œThe preferred platform-specific code for Unicode would be 3 or 4.â€
        # https://developer.apple.com/fonts/TrueType-Reference-Manual/RM06/Chap6name.html
...
# IDs, we follow Unicode practice by omitting â€œmost likely subtagsâ€
# as per Unicode CLDR. For example, English is simply â€œenâ€ and not
# â€œen-Latnâ€ because according to Unicode, the default script
...
_WINDOWS_LANGUAGES = {
    ...
    # extensions (eg., â€œes-u-co-tradâ€ is â€œSpanish with traditional
    # sortingâ€). However, for storing names in fonts, this distinction
    # does not make sense, so we use â€œesâ€ in both cases.
    0x0C0A: "es",
    0x040A: "es",
    0x540A: "es-US",
    0x380A: "es-UY",
...
# done as a (pretty radical) â€œmodificationâ€ of Ethiopic.
#
