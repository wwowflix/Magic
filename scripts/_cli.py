...
class CitationAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, values, optionString):
        ...
        print(f'Date: 2018ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬â„¢{m["version"].split(".", 3)[3][:4]}')
...
def parse_args(argv=None):
    ...
    group.add_argument(
        ...
        dest="jsonlForBuggyIntParser",
        action="store_true",
        default=False,
        help="Output JSONL and insert extra string fields into objects for integers exceeding double precision limits",
    )
    parser.add_argument(
        "--with-entity",
        dest="withEntity",
