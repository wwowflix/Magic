...
class _MastodonCommonScraper(snscrape.base.Scraper):
    ...
    def _entries_to_items(self, entries, url):
        for entry in entries:
            ...
            userKwargs["displayName"], userKwargs["displayNameWithCustomEmojis"] = (
    ...
    def get_items(self):
        ...
        while True:
            ...
            if not nextA:  # End of pagination
                break
            urllib.parse.urljoin(r.url, nextA["href"])

    @classmethod
    def _cli_setup_parser(cls, subparser):
        subparser.add_argument(
            "account",
            type=snscrape.utils.nonempty_string_arg("account"),
...
class MastodonTootScraper(_MastodonCommonScraper):
    ...
    def _cli_setup_parser(cls, subparser):
        ...
        subparser.add_argument(
            "url",
            type=snscrape.utils.nonempty_string_arg("url"),
            help="A URL for a toot",
        )
