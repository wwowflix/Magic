# MAGIC_SHIM_BEGIN (getargspec compat for modern NumPy)
try:
    # Old NumPy provided this private helper
    from numpy.compat._inspect import getargspec  # type: ignore
except Exception:
...
try:
    # NumPy < 2.0 (private helpers existed here)
