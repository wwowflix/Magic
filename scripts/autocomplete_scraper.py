...
# â�"… Define keywords to search for autocomplete suggestions
keywords = ["ai", "chatgpt", "elon", "future", "python", "machine learning"]

# â�"… Store results in a list of dicts
results = []
...
for base_keyword in keywords:
    ...
    try:
        ...
        print(f"â��' Failed to fetch suggestions for '{base_keyword}': {e}")
...
if results:
    ...
    print(f"â�"… Saved {len(results)} autocomplete suggestions to {output_path}")
else:
