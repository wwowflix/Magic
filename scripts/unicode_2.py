...
def is_Default_Ignorable(u):
    ...
    return (
        ...
        or 0x17B4
        <= u
        <= 0x17B5  # Lo   [2] HANGUL CHOSEONG FILLER..HANGUL JUNGSEONG FILLER
        or 0x180B
        <= u
        <= 0x180D  # Mn   [2] KHMER VOWEL INHERENT AQ..KHMER VOWEL INHERENT AA
        ...
        or 0x2060
        <= u
        <= 0x2064  # Cf   [5] LEFT-TO-RIGHT EMBEDDING..RIGHT-TO-LEFT OVERRIDE
        ...
        or 0xE01F0
        <= u
        <= 0xE0FFF  # Mn [240] VARIATION SELECTOR-17..VARIATION SELECTOR-256
