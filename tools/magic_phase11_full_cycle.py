...
def main():
    ...
    # 1️⃣ Auto-Heal
    run_command(f'powershell -ExecutionPolicy Bypass -File "{AUTOHEAL_SCRIPT}"', "STEP 1: Auto-Heal Placeholders")

    # 2️⃣ Master Orchestrator
    run_command(f'powershell -ExecutionPolicy Bypass -File "{ORCHESTRATOR_SCRIPT}"', "STEP 2: Run Master Orchestrator")
