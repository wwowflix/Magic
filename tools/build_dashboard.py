...
# -*- coding: utf-8 -*-
"""
MAGIC â€“ Build Live Dashboard (Week 8 Â· Step 8.2)
...
def build_dashboard(
    ...
    outdir: str,
    title: str = "MAGIC â€“ Runner Dashboard",
    ...
    if not no_html:
        parts = [
            ...
            + (f" Â· Phase filter: <b>{restrict_phase}</b>" if restrict_phase is not None else "")
            + "</p>",
    ...
    print(f"âœ… Dashboard built in: {outdir}")
    return summary
...
def main():
    ...
    ap.add_argument("--title", default="MAGIC â€“ Runner Dashboard")
