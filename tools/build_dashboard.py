...
# -*- coding: utf-8 -*-
"""
MAGIC Ã¢â‚¬â€œ Build Live Dashboard (Week 8 Ã‚Â· Step 8.2)
...
def build_dashboard(
    ...
    outdir: str,
    title: str = "MAGIC Ã¢â‚¬â€œ Runner Dashboard",
    ...
    if not no_html:
        parts = [
            ...
            + (f" Ã‚Â· Phase filter: <b>{restrict_phase}</b>" if restrict_phase is not None else "")
            + "</p>",
    ...
    print(f"Ã¢Å“â€¦ Dashboard built in: {outdir}")
    return summary
...
def main():
    ...
    ap.add_argument("--title", default="MAGIC Ã¢â‚¬â€œ Runner Dashboard")
